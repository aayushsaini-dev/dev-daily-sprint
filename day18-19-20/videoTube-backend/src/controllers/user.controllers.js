...
const registerUser = asyncHandler(async (req, res) => {
  ...
  console.warn("Multer files:", req.files);
  ...
  try {
    ...
    // attempt to clean up uploaded images (don't crash if delete fails)
    try {
      if (avatar) {
      ...
      console.error("Error deleting uploaded images:", delErr);
    }
...
const refreshAccessToken = asyncHandler(async (req, res) => {
  ...
  if (!incomingRefreshToken) {
    throw new ApiError(401, "New Refresh Token is required");
  }
